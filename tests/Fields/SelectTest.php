...
class SelectTest extends TestCase
{
    ...
    {
        $this->makeTemplate('<x-select name="brands" :options="$options"></x-select>')
            ->withData('options', [
                'toyota' => 'Toyota',
                'suzuki' => 'Suzuki',
                'mazda' => 'Mazda'
    ...
    {
        $this->makeTemplate('<x-select name="brands" empty="Seleccione"></x-select>')
            ->assertRender('
                <div id="field-group-brands" class="form-group">
                    <label for="field-brands" > Brands </label>
                    <select id="field-brands" name="brands" class="custom-select">
    ...
    {
        $this->makeTemplate('<x-select name="brands[]" :options="$options" multiple></x-select>')
            ->withData('options', [
                'toyota' => 'Toyota',
                'suzuki' => 'Suzuki',
                'mazda' => 'Mazda'
    ...
    {
        $this->makeTemplate('<x-select name="brands" required></x-select>')
            ->assertRender('
                <div id="field-group-brands" class="form-group">
    ...
    function renders_an_optional_select_field_with_highlights()
    {
        ...
        $this->makeTemplate('<x-select name="brands"></x-select>')
            ->assertRender('
                <div id="field-group-brands" class="form-group">
    ...
    {
        $this->makeTemplate('<x-select name="brands" label="My Label"></x-select>')
            ->assertRender('
                <div id="field-group-brands" class="form-group">
    ...
    {
        $this->makeTemplate('<x-select name="brands" help="This is the help text."></x-select>')
            ->assertRender('
                <div id="field-group-brands" class="form-group">
                    <label for="field-brands" > Brands </label>
                    <select id="field-brands" name="brands" class="custom-select"></select>
    ...
    {
        $this->makeTemplate('<x-select id="brands-id-form" name="brands"></x-select>')
            ->assertRender('
                <div id="field-group-brands" class="form-group">
