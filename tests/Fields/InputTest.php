...
class InputTest extends TestCase
{
    ...
    {
        $this->template('<x-input type="text" name="name" required/>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
    ...
    function renders_an_required_input_with_highlights_in_spanish()
    {
        ...
        $this->template('<x-input type="email" name="email" required/>')
    ...
    function renders_an_optional_input_with_highlights_in_spanish()
    {
        ...
        $this->template('<x-input name="email" type="email"/>')
    ...
    {
        $this->template('<x-input type="text" name="name" id="username"/>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
