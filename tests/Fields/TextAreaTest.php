...
class TextAreaTest extends TestCase
{
    ...
    {
        $this->template('<x-textarea name="name"></x-textarea>')
            ->assertRender('
    ...
    {
        $this->template('<x-textarea name="name" required></x-textarea>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
    ...
    function renders_an_required_textarea_field_without_highlights()
    {
        ...
        $this->template('<x-textarea name="name" required/>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
                    <label for="field-name" > Name </label>
                    <textarea id="field-name" name="name" class="form-control" rows="3" required></textarea>
    ...
    function renders_an_optional_textarea_field_with_highlights()
    {
        ...
        $this->template('<x-textarea name="name"/>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
    ...
    function renders_an_required_textarea_field_with_highlights_in_spanish()
    {
        ...
        $this->template('<x-textarea name="email" required/>')
    ...
    function renders_an_optional_textarea_field_with_highlights_in_spanish()
    {
        ...
        $this->template('<x-textarea name="email"/>')
    ...
    {
        $this->template('<x-textarea name="name" label="My Label"></x-textarea>')
            ->assertRender('
                 <div id="field-group-name" class="form-group">
    ...
    {
        $this->template('<x-textarea name="name" help="This is the help text."></x-textarea>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
                    <label for="field-name" > Name </label>
                    <textarea id="field-name" name="name" class="form-control" rows="3"></textarea>
    ...
    {
        $this->template('<x-textarea name="name" rows="6"></x-textarea>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
                    <label for="field-name" > Name </label>
