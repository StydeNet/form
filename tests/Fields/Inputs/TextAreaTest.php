...
class TextAreaTest extends TestCase
{
        ...
        $this->template('<x-textarea name="name"/>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
                    ...
                    <textarea id="field-name" name="name" rows="3" class="form-control"></textarea>
                </div>
            ');
    }
        ...
        $this->template('<x-textarea name="name" required/>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
                    ...
                    <textarea id="field-name" name="name" rows="3" class="form-control" required="required"></textarea>
                </div>
            ');
    }
    ...
    {
        $this->template('<x-textarea name="name" help="This is a help text."/>')
    ...
    function check_that_error_class_is_displayed()
    {
        ...
        $this->template('<x-textarea name="name"/>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
                    <label for="field-name"> Name <span class="badge badge-danger">Optional</span> </label>
                    <textarea id="field-name" name="name" rows="3" class="form-control is-invalid"></textarea>
