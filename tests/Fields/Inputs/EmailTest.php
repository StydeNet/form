...
class EmailTest extends TestCase
{
    ...
    function render_field_with_required_highlight()
    {
        ...
        $this->template('<x-input-email name="name" required/>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
                    <label for="field-name"> Name <span class="badge badge-danger">Required</span> </label>
                    <input type="email" id="field-name" name="name" value="" class="form-control" required="required">
                </div>
            ');
    }
    ...
    function renders_an_optional_input_text_with_highlights_in_spanish()
    {
        ...
        $this->template('<x-input-email name="email"/>')
    ...
    {
        $this->template('<x-input-email name="name" help="This is a help text."/>')
    ...
    function check_that_error_class_is_displayed()
    {
        ...
        $this->template('<x-input-email name="name"/>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
                    <label for="field-name"> Name <span class="badge badge-danger">Optional</span> </label>
                    <input type="email" id="field-name" name="name" value="" class="form-control is-invalid">
