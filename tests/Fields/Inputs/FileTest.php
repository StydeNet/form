...
class FileTest extends TestCase
{
    ...
    function render_field_with_required_highlight()
    {
        ...
        $this->template('<x-input-file name="name" required/>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
                    <label for="field-name"> Name <span class="badge badge-danger">Required</span> </label>
                    <div class="custom-file">
                        <input type="file" id="field-name" name="name" class="custom-file-input" required="required">
                        <label class="custom-file-label" for="field-name">Choose file</label>
                    </div>
                </div>
            ');
    ...
    function renders_an_optional_input_text_with_highlights_in_spanish()
    {
        ...
        $this->template('<x-input-file name="email"/>')
    ...
    {
        $this->template('<x-input-file name="name" help="This is a help text."/>')
        ...
        $this->template('<x-input-file name="name"/>')
            ->assertRender('
                <div id="field-group-name" class="form-group">
                    <label for="field-name"> Name <span class="badge badge-danger">Optional</span> </label>
                    <div class="custom-file">
                        <input type="file" id="field-name" name="name" class="custom-file-input is-invalid">
                        <label class="custom-file-label" for="field-name">Choose file</label>
