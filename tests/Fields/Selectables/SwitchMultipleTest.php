...
class SwitchMultipleTest extends TestCase
{
    ...
    {
        $this->template('<x-switch-multiple name="languages[]" :options="$options"/>')
            ->withData('options', [
                'js' => 'Javascript',
                'php' => 'PHP',
                'c#' => 'CSharp'
    ...
    {
        $this->template('<x-switch-multiple class="custom-control-inline" name="languages[]" :options="$options"/>')
            ->withData('options', [
                'js' => 'Javascript',
                'php' => 'PHP',
                'c#' => 'CSharp'
    ...
    {
        $this->template('<x-switch-multiple name="languages[]" label="Is Administrator" :options="$options"/>')
            ->withData('options', [
                'js' => 'Javascript',
                'php' => 'PHP',
                'c#' => 'CSharp'
    ...
    {
        $this->template('<x-switch-multiple id="custom-id" name="languages[]" :options="$options"/>')
            ->withData('options', [
                'js' => 'Javascript',
                'php' => 'PHP',
                'c#' => 'CSharp'
    ...
    {
        $this->template('<x-switch-multiple name="languages[]" checked :options="$options"/>')
            ->withData('options', [
                'js' => 'Javascript',
                'php' => 'PHP',
                'c#' => 'CSharp'
    ...
    {
        $this->template('<x-switch-multiple name="languages[]" help="This is the help text." :options="$options"/>')
            ->withData('options', [
                'js' => 'Javascript',
                'php' => 'PHP',
                'c#' => 'CSharp'
    ...
    {
        $this->template('<x-switch-multiple name="languages[]" required :options="$options"/>')
            ->withData('options', [
                'js' => 'Javascript',
                'php' => 'PHP',
                'c#' => 'CSharp'
    ...
    function render_a_checkbox_field_with_errors()
    {
        ...
        $this->template('<x-switch-multiple name="languages[]" label="Administrator?" :options="$options"/>')
            ->withData('options', [
                'js' => 'Javascript',
                'php' => 'PHP',
                'c#' => 'CSharp'
