...
class RadioTest extends TestCase
{
    ...
    {
        $this->makeTemplate('<x-radio name="gender" option="male"/>')
            ->assertRender('
    ...
    {
        $this->makeTemplate('<x-radio name="gender" :options="$options"/>')
            ->withData('options', [
                'm' => 'Male',
                'f' => 'Female',
            ])
    ...
    {
        $this->makeTemplate('<x-radio class="custom-control-inline" name="gender" option="male"/>')
            ->assertRender('
    ...
    {
        $this->makeTemplate('<x-radio class="custom-control-inline" name="gender" :options="$options"/>')
            ->withData('options', [
                'm' => 'Male',
                'f' => 'Female',
            ])
    ...
    {
        $this->makeTemplate('<x-radio name="gender" option="male" label="Man"/>')
            ->assertRender('
                <div id="field-group-gender-male" class="custom-control custom-radio">
                    <input type="radio" id="field-gender-male" name="gender" class="custom-control-input" value="male" >
    ...
    {
        $this->makeTemplate('<x-radio id="field-custom-id" name="gender" option="male"/>')
            ->assertRender('
                <div id="field-group-gender-male" class="custom-control custom-radio">
                    <input type="radio" id="field-gender-male" name="gender" class="custom-control-input" value="male" >
                    <label class="custom-control-label" for="field-gender-male">Male</label>
    ...
    {
        $this->makeTemplate('<x-radio name="gender" option="male" checked/>')
            ->assertRender('
                <div id="field-group-gender-male" class="custom-control custom-radio">
    ...
    {
        $this->makeTemplate('<x-radio name="gender" option="male" help="This is the help text."/>')
            ->assertRender('
                <div id="field-group-gender-male" class="custom-control custom-radio">
                    <input type="radio" id="field-gender-male" name="gender" class="custom-control-input" value="male" >
                    <label class="custom-control-label" for="field-gender-male">Male</label>
    ...
    {
        $this->makeTemplate('<x-radio class="custom-control-inline" name="gender" help="This is the help text." :options="$options"/>')
            ->withData('options', [
                'm' => 'Male',
                'f' => 'Female',
            ])
    ...
    {
        $this->makeTemplate('<x-radio name="gender" option="male" required/>')
            ->assertRender('
                <div id="field-group-gender-male" class="custom-control custom-radio">
    ...
    {
        $this->makeTemplate('<x-radio class="custom-control-inline" name="gender" :options="$options" required/>')
            ->withData('options', [
                'm' => 'Male',
                'f' => 'Female',
            ])
