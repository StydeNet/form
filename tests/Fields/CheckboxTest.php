...
class CheckboxTest extends TestCase
{
    ...
    {
        $this->template('<x-checkbox name="poo" :options="$options"/>')
            ->withData('options', [
                'js' => 'Javascript',
                'php' => 'Php',
            ])
    ...
    {
        $this->template('<x-checkbox class="custom-control-inline" name="is_admin" option="true"/>')
            ->assertRender('
    ...
    {
        $this->template('<x-checkbox class="custom-control-inline" name="poo" :options="$options"/>')
            ->withData('options', [
                'js' => 'Javascript',
                'php' => 'Php',
            ])
    ...
    {
        $this->template('<x-checkbox name="is_admin" option="on" label="Is Administrator"/>')
            ->assertRender('
                <div id="field-group-is_admin-on" class="custom-control custom-checkbox">
                    <input type="checkbox" id="field-is_admin-on" name="is_admin" class="custom-control-input" value="on" >
    ...
    {
        $this->template('<x-checkbox id="field-custom-id" name="is_admin"/>')
            ->assertRender('
                <div id="field-group-is_admin-on" class="custom-control custom-checkbox">
                    <input type="checkbox" id="field-is_admin-on" name="is_admin" class="custom-control-input" value="on" >
                    <label class="custom-control-label" for="field-is_admin-on">On</label>
    ...
    {
        $this->template('<x-checkbox name="poo" help="This is the help text." :options="$options"/>')
            ->withData('options', [
                'js' => 'Javascript',
                'php' => 'Php',
            ])
    ...
    {
        $this->template('<x-checkbox name="poo" :options="$options" required/>')
            ->withData('options', [
                'js' => 'Javascript',
                'php' => 'Php',
            ])
